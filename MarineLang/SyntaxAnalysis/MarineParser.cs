...
namespace MarineLang.SyntaxAnalysis
{
    public class MarineParser
    {
        ...
        public Parser<ExprAst, Token> ParseStaticTerm()
        {
            ...
            return Parse.Or<ExprAst, Token>(funcCallParser.Try(), fieldParser);
        }
        ...
        {
            return Parse.TestOnce<Token>(token =>
            {
